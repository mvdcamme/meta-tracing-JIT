      ...
      (let ((total-number-of-traces-metric-name "total-number-of-traces")
        ...
        (define (run-trace-executions-metric)
          (define (process-result result)
            (output "label-traces") (output (car result)) (output-newline)
            (output "guard-traces") (output (cadr result)) (output-newline)
            (output "mp-tail-traces") (output (caddr result)) (output-newline))
          (output "Metric ") (output trace-executions-metric-name) (output " calculated results: ") (output-newline)
          (process-result (get-trace-executions))
          (output-newline))
